    ...
    <div className="px-12 mx-auto max-w-7xl">
        <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            ...
            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                ...
                <a href="https://github.com/andresdrew02/nestjs-basic-react-client" target="_blank" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-gray-400 text-black rounded-2xl sm:w-auto sm:mb-0">
                    Aprender más
